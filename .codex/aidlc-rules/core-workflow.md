...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files in `.codex/aidlc-rule-details/` directory.
...
1. Load the welcome message from `.codex/aidlc-rule-details/common/welcome-message.md`
